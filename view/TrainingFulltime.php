...
$sql = "SELECT * FROM training WHERE time = 'Full time'";
...
<head>
    ...
    <link href="css/bootstrapF.min.css" rel="stylesheet">
...
<body>
    ...
    <li class="nav-item">
        <a class="nav-link active" href="TrainingF.php">
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '<a class="btn btn-primary" href="TrainingPart.php">Registration</a>';
    echo '</div>';
