                ...
                <form action="add.php" method="post" onsubmit="return validateForm()">  
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4 text-center">Add forum</h2>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="id_user" name="id_utilisateur" value="<?php echo htmlspecialchars($id_utilisateur); ?>" readonly>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="titre">forum title</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="contenue" name="contenue"
                                    placeholder="Content">
                                <label for="contenue">Content</label>
                            </div>
                            <button  type="submit" class="btn btn-success m-2" _msttexthash="95290" _msthash="43">Add</button>            
                        </div>
                    </div>
                    </form>
                </div>
