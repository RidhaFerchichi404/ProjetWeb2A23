                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="id_user" name="id_utilisateur"
                            ...
                            <button  type="submit" class="btn btn-success m-2" _msttexthash="95290" _msthash="43">Ajouter</button>            
                        </div>
                    </div>
                    </form>
                </div>
