                ...
                <form action="update.php?id=<?= $sujet['id_sujet']; ?>" method="post"> 
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4 text-center">Ajouter un forum</h2>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="id_user" name="id_utilisateur" value="<?= $sujet['id_utilisateur']; ?>"
                                    placeholder="Titre de forum">
                                <label for="id_utilisateur">ID</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="titre" name="titre" value="<?= $sujet['titre']; ?>"
                                    placeholder="Titre de forum">
                                <label for="titre">Titre de forum</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="contenue" name="contenue" value="<?= $sujet['contenue']; ?>"
                                    placeholder="Contenu">
                                <label for="contenue">Contenu</label>
                            </div>
                            <button  type="submit" class="btn btn-success m-2" _msttexthash="95290" _msthash="43">Modifier</button>            
                        </div>
                    </div>
                    </form>
                </div>
