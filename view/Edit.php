<?php
include "../cnnx.php"; // Inclure le fichier de connexion à la base de données
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="listTraining.php" class="dropdown-item">liste of training</a>
        ...
        <div class="col-md-6 text-center">
            ...
            <form method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nom" name="nom" value="<?php echo isset($row['nom']) ? $row['nom'] : ''; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="adresse" name="adresse" value="<?php echo isset($row['adress']) ? $row['adress'] : ''; ?>">
                </div>
                <div class="mb-3">
                    <label for="prix" class="form-label">Price</label>
                    <input type="text" class="form-control" id="prix" name="prix" value="<?php echo isset($row['price']) ? $row['price'] : ''; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="photo" name="photo" value="<?php echo isset($row['photo']) ? $row['photo'] : ''; ?>">
                </div>
