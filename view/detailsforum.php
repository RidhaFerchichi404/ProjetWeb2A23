    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Détails du sujet</h1>
            ...
            <div class="container">
                <div class="row gy-5 gx-4">
                    ...
                    <div class="">
                        ...
                        <input type="hidden" name="id_commentaire" value="<?php echo isset($_POST['id_commentaire']) ? $_POST['id_commentaire'] : ''; ?>">
<input type="hidden" name="id_sujet" value="<?php echo isset($_POST['id_sujet']) ? $_POST['id_sujet'] : ''; ?>">
<input type="hidden" name="id_utilisateur" value="<?php echo isset($_POST['id_utilisateur']) ? $_POST['id_utilisateur'] : ''; ?>">

                            <div class="row g-3">
                                <div class="col-12">
                <textarea class="form-control" name="text" rows="5" placeholder="Commenter"></textarea>
            </div>
            <div class="col-12">
                <button class="btn btn-primary w-100" type="submit">Commenter</button>
                            ...
                            <h4 class="mb-4">Liste des commentaires</h4>
