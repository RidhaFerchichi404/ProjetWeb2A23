                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="training.php" class="dropdown-item active">Training</a>
                            <a href="listTraining.php" class="dropdown-item">list of training</a>
    ...
    <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
        <div class="col-md-6 text-center">
            <h3>List of Training</h3>
             ...
             <form method="GET" action="">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Search by Name or adress or id" name="search" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
            ...
            <table class="table table-striped">
                ...
                // Construction de la requête SQL avec la recherche
                $sql = "SELECT * FROM training ";
                $params = [];

                if (!empty($search)) {
                    $sql .= "WHERE nom LIKE ? OR adress LIKE ? OR id_training = ?";
                    $params = ["%$search%", "%$search%", $search];
                }

                // Exécution de la requête SQL avec la recherche
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>";
                    echo "<td>" . (isset($row['nom']) ? $row['nom'] : '') . "</td>";
                    echo "<td>" . (isset($row['date']) ? $row['date'] : '') . "</td>";
                    echo "<td>" . (isset($row['adress']) ? $row['adress'] : '') . "</td>";
                    echo "<td>" . (isset($row['price']) ? $row['price'] : '') . "</td>";
                    echo "<td>" . (isset($row['description']) ? $row['description'] : '') . "</td>";

                    echo "<td>";
                    echo "<a href='Edit.php?id=" . $row['id_training'] . "' class='btn btn-sm btn-primary'><i class='fas fa-edit'></i></a>";
                    echo "<a href='Delete.php?id=" . $row['id_training'] . "' class='btn btn-sm btn-danger ms-2'><i class='fas fa-trash'></i></a>";
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    ...
                    // Next page link
                    if ($page < $total_pages) {
                        echo "<li class='page-item'><a class='page-linkhref='?page=".($page + 1)."&search=".urlencode($search)."'>Next</a></li>";
                    }
                    ?>
                </ul>
            </nav>
