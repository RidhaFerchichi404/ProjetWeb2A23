    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            ...
            <form action="add.php" method="post"  onsubmit="return validateForm()" >
                <div class="row g-3">
                    <label for="id_user"><h2>Id utilisateur:</h2></label><br>
                    <input type="text" id="id_user" name="id_utilisateur"><br>
                    <label for="titre"><h2>Titre du Poste:</h2></label><br>
                     <input type="text" id="titre" name="titre" ><br>
                     <label for="contenue"><h2>Contenu du Poste:</h2></label><br>
                      <textarea id="contenue" name="contenue" ></textarea><br>
                      <input type="submit" name="publier" value="Publier" class="btn_primary">
                     </div>
                    </form>
            </div>
        </div>
